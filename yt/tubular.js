...
},{"tubular":2}],2:[function(require,module,exports){
'use strict';
...
(function (angular) {
    ...
    angular.module('tubular', ['tubular.core', 'tubular.directives', 'tubular.services', 'tubular.models']).info({ version: '1.8.4' });
})(angular);
    ...
    angular.module('tubular.directives').controller('tbFormController', ['$scope', '$timeout', '$element', 'tubularModel', '$http', 'modelSaver', function ($scope, $timeout, $element, TubularModel, $http, modelSaver) {
        ...
        function getUrlWithKey() {
            if (!$scope.urlQueryString) {
                ...
                var queryStringValue = $scope.urlQueryString + '=' + $scope.modelKey;
